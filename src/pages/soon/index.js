            ...
            <Box sx={{ p: 5, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                <BoxWrapper>
                    ...
                    <Typography variant='h5' sx={{ mb: 1, fontSize: '1.5rem !important' }}>
                        🤫 This is a Demo of our final product
                    </Typography>
                    <Typography variant='body2'>If you want to be part of the story make sure to hit us up on our Website!</Typography>
                </BoxWrapper>
                ...
                <br />
                <Link passHref href='http://affistash.com/'>
